        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          <div className="w-full lg:w-1/2 space-y-8">
            ...
            <p className="text-xl text-foreground/80 leading-relaxed">
              We believe that everyone deserves the chance to showcase their
              true potential. Our mission is to democratize interview
              preparation by making high-quality, personalized coaching
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-card-foreground/70">
                      Take unlimited mock interviews tailored to your target
                      role and industry.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-card-foreground/70">
                      Review detailed feedback on your answers, body language,
                      and speaking pace.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-card-foreground/70">
                      Follow personalized recommendations to refine your skills
